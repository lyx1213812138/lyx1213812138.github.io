...
packages:
  ...
  /hexo-browsersync@0.3.0:
    resolution: {integrity: sha512-5grkDUG/jci1LgImUFHTGMhXRYFKYuBVVf1L62UAhd/IC/L3EfGtKXyPVqvxyVb4Pc5STY5tQR46xoBJLlWJNw==}
    engines: {node: '>= 0.10.0'}
    dependencies:
      browser-sync: 2.29.3
      connect-injector: 0.4.4
  ...
  /hexo-filter-mathjax@0.9.0:
    resolution: {integrity: sha512-tTeaRLQjE60m4dSHA+SCXHYsTcqN6bGGxA+3Zzw6GHMBweIZNKXOS0ctUq32PuwejFlLKUSAeQdhhvTBOrgKMA==}
    dependencies:
      mathjax-full: 3.2.2
    dev: false
  ...
  /hexo-hide-posts@0.4.3:
    resolution: {integrity: sha512-5VLzaX6ntJ0uJy56X5tgbII6oucBoUS5gCzm37ozXibMT8lBmRgbuzzayKNuBL+oQpyAa+vEsLyxlSunyaRs7g==}
    dependencies:
      chalk: 4.1.2
    dev: false
  ...
  /hexo-renderer-mathjax@0.6.0:
    resolution: {integrity: sha512-S6bWVzBBp1cuMUOqjqnQgMspwpS05slrWZ1gqIbi7OF3spBEOpGa26hC7j7dP55oNCDmcbK7PE+i/l3Q6qRYoQ==}
    dependencies:
      ejs: 1.0.0
    dev: false

  /hexo-renderer-pandoc@0.4.0:
    resolution: {integrity: sha512-e913A2EZbhwbIfg+QvYUalEPHtK5qs9Rqj3ZrsQ3cYTbbiETMWhUQ7bzSlgUeh639eL0UDuBmv2vrEqj5RBchg==}
    dev: false
